...
export function ProjectSidebar() {
  ...
  const collapsedContent = (
    <div className="flex flex-col h-full items-center">
      <div className="py-4 px-2 border-b border-gray-100 dark:border-gray-700 w-full flex flex-col items-center gap-3">
        <button
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className={cn(
        'hidden lg:flex flex-col bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-700 min-h-screen sticky top-0 transition-all duration-200',
        collapsed ? 'w-14' : 'w-60'
      )}>
